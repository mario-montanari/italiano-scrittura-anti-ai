...
`references/scudo-falsi-positivi.md`: leggerlo prima di procedere.
...
risponde di no e ci si ferma; la sezione 1 del reference spiega perché.
...
citato e mai aperto è una promessa, non una prova.
...
Seguire il modello della sezione 7 del reference, o quello della sezione 8 se
...
Tre casi, e in tutti si dice il motivo.
...
genere del suo testo, che è l'argomento della sezione 5 del reference e non
...
- Le cifre del reference invecchiano: i rilevatori cambiano in fretta.
